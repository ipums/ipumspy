...
def test_read_noextract_codebook():
    ...
    assert codebook.ipums_citation == "Matthew Sobek, Daniel Backman, Greg Freedman Ellis, and Kari C.W. Williams. IPUMS Youth Risk Behavior Surveillance System: Version 1.0 [dataset]. Minneapolis, MN: IPUMS, 2017. https://doi.org/10.18128/D0111.V1.0."
